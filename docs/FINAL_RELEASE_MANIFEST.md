# v0.1.17 Final Release Manifest
...
Excluded: private data, machine-local configuration, generated validation runs, `PROJECT_BACKUPS/`, internal state/agent files, obsolete release candidates, and ambiguous example output.

See `SHA256SUMS.txt` inside the package and the archive's `.sha256` sidecar for final file and archive hashes.
